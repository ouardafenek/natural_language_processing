...
# Another encoder, the idea is alwats the same
# This one allows the possibility of changing the cell's type (gru/lstm)
# It is the encoder proposed by IBM for Seq2seq tasks.  

class EncoderRNN(Base):
    r"""
    ...
    Args:
        ...
        rnn_cell (str, optional): type of RNN cell (default: gru) (you can use LSTM)
    ...
    Examples::
         >>> encoder = Encoder(input_vocab, max_seq_length, hidden_size)
